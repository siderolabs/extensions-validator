...
all: unit-tests extensions-validator image-extensions-validator lint
...
.PHONY: $(ARTIFACTS)/extensions-validator-linux-amd64
$(ARTIFACTS)/extensions-validator-linux-amd64:
	@$(MAKE) local-extensions-validator-linux-amd64 DEST=$(ARTIFACTS)
...
.PHONY: image-extensions-validator
image-extensions-validator:  ## Builds image for extensions-validator.
	@$(MAKE) registry-$@ IMAGE_NAME="extensions-validator"
