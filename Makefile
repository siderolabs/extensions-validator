...
.PHONY: sign-image-extensions-validator
sign-image-extensions-validator:  ## Signs the image for extensions-validator. Requires interactive Google authentication.
	@test -n "$$GITHUB_TOKEN" || { \
	...
	@TMP=$$(mktemp -d) && trap 'rm -rf "$$TMP"' EXIT && \
	  ...
	  docker run --rm -p 127.0.0.1:8585:8585 \
	    ...
	    $(REGISTRY)/$(USERNAME)/extensions-validator:$(IMAGE_TAG)
